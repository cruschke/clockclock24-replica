...
**Tests**: Include verification tasks for every user story. Automated tests are
preferred when feasible; simulation/manual hardware validation tasks are required
when automation is not practical.
...
- [ ] T004 [P] Define feature-level performance measurement method and baseline
- [ ] T005 [P] Define UX consistency checklist for user-visible changes
...
- [ ] T014 [US1] Document manual/simulation validation steps when hardware behavior is changed
...
- [ ] T021 [US1] Verify UX terminology/behavior consistency for changed screens or controls
- [ ] T022 [US1] Validate story performance target(s) and record results
...
- [ ] T025 [US2] Document manual/simulation validation steps when hardware behavior is changed
...
- [ ] T030 [US2] Verify UX terminology/behavior consistency for changed screens or controls
- [ ] T031 [US2] Validate story performance target(s) and record results
...
- [ ] T034 [US3] Document manual/simulation validation steps when hardware behavior is changed
...
- [ ] T038 [US3] Verify UX terminology/behavior consistency for changed screens or controls
- [ ] T039 [US3] Validate story performance target(s) and record results
...
- [ ] TXXX Constitution compliance review against all five principles
...
- Verification tasks MUST be completed and reviewed before story sign-off
- Automated tests SHOULD be written and FAIL before implementation where feasible
