...
- **VE-001**: Define how this feature will be verified (automated tests,
  simulation checks, and/or manual hardware validation steps).
- **VE-002**: For each user story, define pass/fail evidence that can be reviewed
